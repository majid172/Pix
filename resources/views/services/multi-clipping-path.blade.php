        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <img src="{{asset('front-assets/images/multi_clip/multi_Clip.png')}}" class="fit-image" alt="clipping path">
                </div>
                <div class="col-12 col-md-6">
                    <div class="row intro">
    ...
    <section class="section-1 title" >
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <img src="{{asset('front-assets/images/multi_clip/multi.png')}}" class="fit-image" alt="Jewelry Retouch">
                </div>
        ...
        <div class="overflow-holder">
            <div class="container">
                <div class="row text-center intro">
                    <div class="col-12 heading">
                        <h3 class="mb-0">@lang('Multi-Clipping Sample')</h3>
